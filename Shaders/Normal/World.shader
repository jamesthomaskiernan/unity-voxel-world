Shader "Shaders/World" {
    Properties {
        ...
        _NormTex("Real Normal Map", 2D) = "white" {}
    ...
    SubShader{
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/HLSL/WorldVertexFinder.hlsl" 
            #include "Assets/Shaders/HLSL/CustomLitForwardPass.hlsl" 
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Shaders/LitInput.hlsl"
            #include "Assets/Shaders/HLSL/WorldVertexFinder.hlsl" 
            #include "Assets/Shaders/HLSL/CustomLitDepthNormalsPass.hlsl" 
            ENDHLSL
        }

        // Includes World's vertices in the camera depth texture
        Pass
        {
            Name "DepthOnly"
